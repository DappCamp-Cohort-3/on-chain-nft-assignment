...
contract DappCampNFT is ERC721Enumerable, Ownable {
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        // Build the NFT image
        parts[0] = '<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"';
        parts[1] = '     viewBox="0 0 1280 720" style="enable-background:new 0 0 1280 720;" xml:space="preserve">';
        parts[2] = '<style type="text/css">';
        parts[3] = '    .st0{fill:#FFFFFF;}';
        parts[4] = '    .st1{fill:#000000;}';
        parts[5] = '    .st2{fill:#FF0029;} .base { fill: black; font-family: arial; font-size: 36px; }';
        parts[6] = '</style>';
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "DATA #', Strings.toString(tokenId), '", "description": "Web3 enables a new data economy. The Web3 data economy is an ecosystem of data-centric protocols and applications disrupting the data monopolies built in Big Tech. DATA provides exposure to the growth of the Web3 data economy in a single token.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
