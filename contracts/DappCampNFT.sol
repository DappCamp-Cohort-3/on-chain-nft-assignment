...
contract DappCampNFT is ERC721Enumerable, Ownable {
    ...
    string[] private collection = ["BTC", "ETH", "BNB", "USDT", "USDC"];
    ...
    {
        string
            memory svgView = '<svg xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMinYMin meet" viewBox="0 0 350 350"><rect width="100%" height="100%" fill="white" /><text x="10" y="20" class="base">';
